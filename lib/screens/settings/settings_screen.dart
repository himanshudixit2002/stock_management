        ...
        _SettingsCard(
          children: [
            _SettingsTile(
              ...
              onTap: () => _launchUrl(context, 'https://smartinventory.com/privacy-policy.html'),
            ),
            const Divider(height: 1, indent: 56),
            _SettingsTile(
              ...
              onTap: () => _launchUrl(context, 'https://smartinventory.com/terms.html'),
            ),
            const Divider(height: 1, indent: 56),
            _SettingsTile(
              ...
              title: 'Support',
              onTap: () => _launchUrl(context, 'https://smartinventory.com/support.html'),
            ),
            const Divider(height: 1, indent: 56),
            _SettingsTile(
              ...
              iconColor: AppTheme.dangerColor,
              title: 'Data Deletion',
              onTap: () => _launchUrl(context, 'https://smartinventory.com/data-deletion.html'),
            ),
          ],
        ),
