...
class _AddEditVendorScreenState extends State<AddEditVendorScreen> {
  ...
  void initState() {
    ...
    _leadTimeCtrl =
        TextEditingController(text: v != null && v.leadTimeDays > 0 ? v.leadTimeDays.toString() : '');
  ...
  Future<void> _save() async {
    ...
    final success = _isEditing
        ? await vendorProvider.updateVendor(vendor)
        ...
        child: ListView(
          ...
          children: [
              ...
              children: [
                ...
                ...List.generate(5, (i) {
                  return GestureDetector(
                    onTap: () => setState(() =>
                        _rating = (_rating == i + 1) ? 0 : (i + 1).toDouble()),
                    child: Padding(
            ...
            SwitchListTile(
              ...
              subtitle: Text(
                _isActive ? 'Vendor is available for selection' : 'Vendor is hidden from selection',
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                child: _saving
                    ...
                    : Text(_isEditing ? 'Update Vendor' : 'Add Vendor',
