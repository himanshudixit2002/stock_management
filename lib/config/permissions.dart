...
class AppPermissions {
  ...
  static const List<PermissionDef> all = [
    ...
    PermissionDef(
      key: viewReports,
      label: 'View Reports',
      description: 'Access all report screens',
      group: 'dashboard',
    ...
    PermissionDef(
      key: stockOut,
      label: 'Stock Out',
      description: 'Remove stock from products',
      group: 'stock',
    ...
    PermissionDef(
      key: bulkStockIn,
      label: 'Bulk Stock In',
      description: 'Add stock to multiple products at once',
      group: 'stock',
    ...
    PermissionDef(
      key: holdStock,
      label: 'Hold Stock',
      description: 'Create stock holds/reservations',
      group: 'stock',
      icon: Icons.pause_circle_rounded,
    ),
    PermissionDef(
      key: releaseStock,
      label: 'Release Held Stock',
      description: 'Release active stock holds',
      group: 'stock',
      icon: Icons.play_circle_rounded,
    ),
    PermissionDef(
      key: viewStockHolds,
      label: 'View Stock Holds',
      description: 'View stock hold history and status',
      group: 'stock',
    ...
    PermissionDef(
      key: approvePurchaseOrders,
      label: 'Approve Purchase Orders',
      description: 'Approve and send purchase orders to vendors',
      group: 'purchaseOrders',
      icon: Icons.check_circle_rounded,
    ),
    PermissionDef(
      key: receivePurchaseOrders,
      label: 'Receive Purchase Orders',
      description: 'Mark items as received on purchase orders',
      group: 'purchaseOrders',
      icon: Icons.move_to_inbox_rounded,
    ),
    PermissionDef(
      key: cancelPurchaseOrders,
    ...
    PermissionDef(
      key: dispatchSalesOrders,
      label: 'Dispatch Sales Orders',
      description: 'Mark sales orders as dispatched',
      group: 'salesOrders',
      icon: Icons.local_shipping_rounded,
    ),
    PermissionDef(
      key: deliverSalesOrders,
      label: 'Deliver Sales Orders',
      description: 'Mark sales orders as delivered',
      group: 'salesOrders',
      icon: Icons.done_all_rounded,
    ),
    PermissionDef(
      key: cancelSalesOrders,
      label: 'Cancel Sales Orders',
    ...
    PermissionDef(
      key: viewReturns,
      label: 'View Returns',
      description: 'View returns list and details',
      group: 'returns',
      icon: Icons.visibility_rounded,
    ),
    PermissionDef(
      ...
      description: 'Create new return requests',
      group: 'returns',
      icon: Icons.add_circle_rounded,
    ),
    PermissionDef(
    ...
    PermissionDef(
      ...
      description: 'Process approved returns (adjust stock)',
      group: 'returns',
    ...
    PermissionDef(
      key: editVendors,
      label: 'Edit Vendors',
      description: 'Modify existing vendor details',
      group: 'vendors',
      icon: Icons.edit_rounded,
    ),
    PermissionDef(
    ...
    PermissionDef(
      key: manageStockTakes,
      label: 'Manage Stock Takes',
      description: 'Create and conduct stock takes',
      group: 'inventory',
      icon: Icons.fact_check_rounded,
    ),
    PermissionDef(
      key: viewExpiryAlerts,
      label: 'View Expiry Alerts',
      description: 'View batch expiry notifications',
      group: 'inventory',
      icon: Icons.timer_rounded,
    ),
    PermissionDef(
      key: viewReorderSuggestions,
      label: 'View Reorder Suggestions',
      description: 'View reorder point alerts',
      group: 'inventory',
      icon: Icons.shopping_cart_checkout_rounded,
    ),
    PermissionDef(
      key: viewStockForecast,
      label: 'View Stock Forecast',
      description: 'View stock demand forecasts',
      group: 'inventory',
    ...
    PermissionDef(
      ...
      description: 'Record payments on invoices',
      group: 'billing',
    ...
    PermissionDef(
      key: manageUsers,
      label: 'Manage Users',
      description: 'Add, edit roles, and remove users',
      group: 'users',
    ...
    // Settings & Company
    PermissionDef(
      key: manageCompanySettings,
      label: 'Manage Company Settings',
      description: 'Edit company settings and preferences',
      group: 'settings',
      icon: Icons.business_rounded,
    ),
    PermissionDef(
      key: manageWarehouseZones,
      label: 'Manage Warehouse Zones',
      description: 'Create and manage warehouse zones',
      group: 'settings',
      icon: Icons.warehouse_rounded,
    ),
    PermissionDef(
      key: manageNotificationSettings,
  ...
  static Map<String, bool> allTrue() => {for (final p in all) p.key: true};
  ...
  static const Map<String, List<String>> legacyKeyMapping = {
    ...
    'canManageSalesOrders': [
      ...
      'canConfirmSalesOrders',
      'canDispatchSalesOrders',
      'canDeliverSalesOrders',
      'canCancelSalesOrders',
    ],
    'canManageReturns': [
      'canViewReturns',
      'canCreateReturns',
