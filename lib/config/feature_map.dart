...
class FeatureMap {
  ...
  static const List<FeatureEntry> all = [
    ...
    FeatureEntry(
      id: 'aging',
      label: 'Ageing',
      subtitle: 'Receivables and payables by how overdue they are',
      icon: Icons.hourglass_bottom_rounded,
      route: AppRoutes.aging,
      category: FeatureCategory.billing,
    ...
    FeatureEntry(
      id: 'paymentsLedger',
      label: 'Payments',
      subtitle: 'Every payment received and paid out',
      icon: Icons.payments_rounded,
      route: AppRoutes.paymentsLedger,
      category: FeatureCategory.billing,
      placement: FeaturePlacement.searchOnly,
      permissionKey: AppPermissions.viewInvoices,
      featureGates: [HomeActionFeatureGate.billing],
    ...
    FeatureEntry(
      id: 'stockLedger',
      label: 'Stock Ledger',
      subtitle: 'Every movement for a product with a running balance',
      icon: Icons.receipt_long_rounded,
      route: AppRoutes.stockLedger,
      category: FeatureCategory.reports,
      placement: FeaturePlacement.searchOnly,
      permissionKey: AppPermissions.viewReports,
      sortOrder: 7,
    ...
    FeatureEntry(
      ...
      route: AppRoutes.dataHealth,
      category: FeatureCategory.admin,
      placement: FeaturePlacement.settingsOnly,
      permissionKey: AppPermissions.manageCompanySettings,
      sortOrder: 90,
    ),
    FeatureEntry(
      id: 'excelImport',
    ...
    // ---------------- Smart Inventory (later additions) ----------------
    FeatureEntry(
      id: 'boms',
      label: 'Bills of Materials',
      subtitle: 'Build finished goods from their components',
      icon: Icons.account_tree_rounded,
      route: AppRoutes.boms,
      category: FeatureCategory.inventory,
      placement: FeaturePlacement.homeSecondary,
      permissionKey: AppPermissions.viewBoms,
      sortOrder: 6,
    ),
    FeatureEntry(
      id: 'serials',
      label: 'Serial Numbers',
      subtitle: 'Track individual units for warranty and returns',
      icon: Icons.qr_code_2_rounded,
      route: AppRoutes.serials,
      category: FeatureCategory.inventory,
      placement: FeaturePlacement.homeSecondary,
      permissionKey: AppPermissions.viewSerials,
      sortOrder: 7,
    ),
    FeatureEntry(
      id: 'transferOrders',
      label: 'Transfer Orders',
      subtitle: 'Move stock between locations, with in-transit visibility',
      icon: Icons.local_shipping_rounded,
      route: AppRoutes.transferOrders,
      category: FeatureCategory.inventory,
      placement: FeaturePlacement.homeSecondary,
      permissionKey: AppPermissions.viewTransferOrders,
      sortOrder: 8,
    ),
    FeatureEntry(
      id: 'labelPrint',
      label: 'Label Printing',
      subtitle: 'Print barcode and shelf labels for your products',
      icon: Icons.local_offer_rounded,
      route: AppRoutes.labelPrint,
      category: FeatureCategory.inventory,
      placement: FeaturePlacement.tabShortcut,
      permissionKey: AppPermissions.printLabels,
      featureGates: [HomeActionFeatureGate.barcode],
      sortOrder: 3,
    ),

    // ---------------- Orders & Customers (later additions) ----------------
    FeatureEntry(
      id: 'requisitions',
      label: 'Requisitions',
      subtitle: 'Request stock and route it through approval',
      icon: Icons.assignment_rounded,
      route: AppRoutes.requisitions,
      category: FeatureCategory.orders,
      placement: FeaturePlacement.homeSecondary,
      permissionKey: AppPermissions.viewRequisitions,
      sortOrder: 4,
    ),
    FeatureEntry(
      id: 'landedCosts',
      label: 'Landed Costs',
      subtitle: 'Spread freight and duty onto what the stock really cost',
      icon: Icons.local_shipping_outlined,
      route: AppRoutes.landedCosts,
      category: FeatureCategory.orders,
      placement: FeaturePlacement.searchOnly,
      permissionKey: AppPermissions.viewLandedCosts,
      featureGates: [HomeActionFeatureGate.pricing],
      sortOrder: 5,
    ),

    // ---------------- Billing (later additions) ----------------
    FeatureEntry(
      id: 'recurringInvoices',
      label: 'Billing Schedules',
      subtitle: 'Issue recurring invoices without re-keying them',
      icon: Icons.event_repeat_rounded,
      route: AppRoutes.recurringInvoices,
      category: FeatureCategory.billing,
      placement: FeaturePlacement.homeSecondary,
      permissionKey: AppPermissions.viewRecurringInvoices,
      featureGates: [HomeActionFeatureGate.billing],
      sortOrder: 2,
    ),
    FeatureEntry(
      id: 'priceLists',
      label: 'Price Lists',
      subtitle: 'Give customers their own prices and discount tiers',
      icon: Icons.sell_rounded,
      route: AppRoutes.priceLists,
      category: FeatureCategory.billing,
      placement: FeaturePlacement.homeSecondary,
      permissionKey: AppPermissions.viewPriceLists,
      featureGates: [HomeActionFeatureGate.pricing],
      sortOrder: 3,
    ),

    // ---------------- Insights & Reports (later additions) ----------------
    FeatureEntry(
      id: 'taxSummary',
      label: 'Tax Summary',
      subtitle: 'Output and input tax by rate, for the period',
      icon: Icons.receipt_long_rounded,
      route: AppRoutes.taxSummary,
      category: FeatureCategory.reports,
      placement: FeaturePlacement.homeSecondary,
      permissionKey: AppPermissions.viewTaxReports,
      featureGates: [HomeActionFeatureGate.billing],
      sortOrder: 9,
    ),
    FeatureEntry(
      id: 'deadStock',
      label: 'Dead Stock',
      subtitle: 'Which stock has stopped moving, and what it ties up',
      icon: Icons.hourglass_disabled_rounded,
      route: AppRoutes.deadStock,
      category: FeatureCategory.reports,
      placement: FeaturePlacement.homeSecondary,
      permissionKey: AppPermissions.viewDeadStock,
      sortOrder: 10,
    ),

    // ---------------- Second wave: order-to-cash ----------------
    FeatureEntry(
      id: 'quotations',
      label: 'Quotations',
      subtitle: 'Price an offer, chase it, and turn a yes into an order',
      icon: Icons.request_quote_rounded,
      route: AppRoutes.quotations,
      category: FeatureCategory.orders,
      placement: FeaturePlacement.homeSecondary,
      permissionKey: AppPermissions.viewQuotations,
      sortOrder: 6,
    ),
    FeatureEntry(
      id: 'shipments',
      label: 'Pick, Pack & Ship',
      subtitle: 'Pick lists and packages behind every dispatch',
      icon: Icons.inventory_rounded,
      route: AppRoutes.shipments,
      category: FeatureCategory.orders,
      placement: FeaturePlacement.homeSecondary,
      permissionKey: AppPermissions.viewShipments,
      sortOrder: 7,
    ),
    FeatureEntry(
      id: 'serviceJobs',
      label: 'Service & Repairs',
      subtitle: 'Book units in, fit parts, and hand them back',
      icon: Icons.build_circle_rounded,
      route: AppRoutes.serviceJobs,
      category: FeatureCategory.orders,
      placement: FeaturePlacement.homeSecondary,
      permissionKey: AppPermissions.viewServiceJobs,
      sortOrder: 8,
    ),
    ...
    FeatureEntry(
      id: 'expenses',
      label: 'Expenses',
      subtitle: 'Rent, wages and everything else that is not stock',
      icon: Icons.account_balance_wallet_rounded,
    ...
    FeatureEntry(
      ...
      subtitle: 'Open a till with a float and cash it up blind',
      icon: Icons.savings_rounded,
      route: AppRoutes.registerSessions,
      category: FeatureCategory.billing,
      placement: FeaturePlacement.homeSecondary,
      permissionKey: AppPermissions.viewRegisterSessions,
      featureGates: [HomeActionFeatureGate.billing],
      sortOrder: 5,
    ),
    FeatureEntry(
      ...
      subtitle: 'Who owes what, against the limit you gave them',
      icon: Icons.credit_score_rounded,
      route: AppRoutes.creditControl,
      category: FeatureCategory.billing,
      placement: FeaturePlacement.homeSecondary,
      permissionKey: AppPermissions.viewCreditControl,
      featureGates: [HomeActionFeatureGate.billing],
      sortOrder: 6,
    ),

    // ---------------- Second wave: inventory ----------------
    FeatureEntry(
      id: 'jobWork',
      label: 'Job Work',
      subtitle: 'Send components to a subcontractor and get goods back',
      icon: Icons.handyman_rounded,
      route: AppRoutes.jobWork,
      category: FeatureCategory.inventory,
      placement: FeaturePlacement.homeSecondary,
      permissionKey: AppPermissions.viewJobWork,
      sortOrder: 9,
    ),
    ...
    FeatureEntry(
      ...
      subtitle: 'Which suppliers deliver on time, in full, at the price',
      icon: Icons.grading_rounded,
      route: AppRoutes.vendorScorecard,
      category: FeatureCategory.reports,
      placement: FeaturePlacement.homeSecondary,
      permissionKey: AppPermissions.viewVendorScorecard,
      featureGates: [HomeActionFeatureGate.vendors],
      sortOrder: 11,
    ),
    FeatureEntry(
      id: 'commissions',
      label: 'Commissions',
      subtitle: 'What each salesperson earned, from the invoices',
      icon: Icons.workspace_premium_rounded,
      route: AppRoutes.commissionStatement,
      category: FeatureCategory.reports,
      placement: FeaturePlacement.homeSecondary,
      permissionKey: AppPermissions.viewCommissions,
      sortOrder: 12,
    ),
    FeatureEntry(
      id: 'budgets',
      label: 'Budgets',
      subtitle: 'What you planned to earn and spend, against what happened',
      icon: Icons.donut_small_rounded,
      route: AppRoutes.budgets,
      category: FeatureCategory.reports,
      placement: FeaturePlacement.homeSecondary,
      permissionKey: AppPermissions.viewBudgets,
      sortOrder: 13,
    ),
  ];
